...
async def start(event):
    ...
    if event.is_private:
       ...
       await event.reply(
             ...
             buttons=[
        [Button.url("Add me to your group ➕", url="t.me/AnnexManager_Bot?startgroup=true")],
        [Button.url("Channel 📢", url="t.me/Techno_Trickop"), Button.url("Support 🌎", url="t.me/Techno_Trickop")],
...
async def help(event):
    if event.is_group:
        buttons = [
            [Button.url("❔ Help", "https://t.me/AnnexManager_Bot?start=_help")],
        ]
        await event.reply(
